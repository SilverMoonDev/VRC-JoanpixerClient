    ...
    static class Utils
    {
        ...
        public static IEnumerator ONUUIUSER()
        {
            ...
            ButtonAPI.OnInit += () =>
            {
                ...
                var UdonEventsMenu = new MenuPage("UdonEvents", "Udon Events");

                var UdonEventsButtons = new ButtonGroup(UdonEventsMenu, null);

                var UdonEventMenu = new MenuPage("Event", "");
                ...
                var TouchSystemMenu = new MenuPage("TouchSystem", "Touch System");
                ...
                WorldHacks = new SingleButton(MainMenuButtons, "Worlds Hacks", "Opens Worlds Exploits Menu", () =>
                {
                    if (Murder4.worldLoaded)
                        ...
                        MelonCoroutines.Start(Notification("Available Worlds: Murder 3/4, Among Us, Ghost, \nJust B Club and Prison Escape", Color.green));
                }, false);
                ...
                new ToggleButton(annoybuttons, "Walking Bomb", null, null, (val) =>
                {
                    ...
                    try
                    {
                        ...
                        if (PatchManager.WalkingBomb)
                        {
                            MelonCoroutines.Start(Murder4.WalkingBomb());
                        }
                        else
                        {
                            MelonCoroutines.Stop(Murder4.WalkingBomb());
                        }
                    }
                    catch { }
                }).SetToggleState(false, false);
                ...
                new SimpleSingleButton(JustBClubRoomsButtons, "1", null, () =>
                {
                    ...
                    TPLocalPlayer(new Vector3(-217.7101f, -11.755f, 151.0652f));
                });
                ...
                new SimpleSingleButton(JustBClubRoomsButtons, "2", null, () =>
                {
                    ...
                    Just_B_Club.Bedroom6.SetActive(false);
                    Just_B_Club.Bedroom7.SetActive(false);
                    TPLocalPlayer(new Vector3(-217.3516f, 55.245f, -91.66356f));
                });
                ...
                new SimpleSingleButton(JustBClubRoomsButtons, "3", null, () =>
                {
                    ...
                    Just_B_Club.Bedroom6.SetActive(false);
                    Just_B_Club.Bedroom7.SetActive(false);
                    TPLocalPlayer(new Vector3(-119.0256f, -11.755f, 151.1068f));
                });
                ...
                new SimpleSingleButton(JustBClubRoomsButtons, "4", null, () =>
                {
                    ...
                    Just_B_Club.Bedroom6.SetActive(false);
                    Just_B_Club.Bedroom7.SetActive(false);
                    TPLocalPlayer(new Vector3(-116.8698f, 55.245f, -91.59067f));
                });
                ...
                new SimpleSingleButton(JustBClubRoomsButtons, "5", null, () =>
                {
                    ...
                    Just_B_Club.Bedroom6.SetActive(false);
                    Just_B_Club.Bedroom7.SetActive(false);
                    TPLocalPlayer(new Vector3(-18.62112f, -11.755f, 150.9862f));
                });
                ...
                new SimpleSingleButton(JustBClubRoomsButtons, "6", null, () =>
                {
                    ...
                    Just_B_Club.Bedroom7.SetActive(false);
                    TPLocalPlayer(new Vector3(-17.56843f, 55.245f, -91.55622f));
                });
                ...
                new SimpleSingleButton(JustBClubRoomsButtons, "VIP Room", null, () =>
                {
                    ...
                    TPLocalPlayer(new Vector3(58.17721f, 62.3625f, -6.299268f));
                });
                #endregion
                ...
                new SimpleSingleButton(PrisonTpButtons, "Tower 1", "Right Tower", () =>
                {
                    Utils.TPLocalPlayer(new Vector3(60.8f, 10.5f, 281.4f));
                });

                new SimpleSingleButton(PrisonTpButtons, "Tower 2", "Left Tower", () =>
                {
                ...
                new ToggleButton(PickupsButtons, "Thief", "Allows Thief of Pickups", "Allows Thief of Pickups", (val) =>
                {
                    ...
                    {
                        Items.DisallowThief();
                        if (VRCPlayer.field_Internal_Static_VRCPlayer_0.Method_Public_VRCHandGrasper_ControllerHand_0(ControllerHand.Right).field_Internal_Boolean_1)
                        {
                ...
                AntiTheftuwu = new ToggleButton(PickupsButtons, "Anti World Drop", "The world can't drop your pickups", "The world can't drop your pickups", (val) =>
                {
                    Items.AntiTheftenabled = val;
                    Create.Ini.SetBool("Toggles", "AntiTheft", val);
                    if (!val)
                    {
                        PatchManager.pickup = false;
                    }
                });

                AntiTheftuwu.SetToggleState(Create.Ini.GetBool("Toggles", "AntiTheft"), false);
                ...
                new ToggleButton(PickupsButtons, "Item Lag", "", "", (val) =>
                {
                    if (val)
                    {
                        Items.itemlag = true;
                ...
                new ToggleButton(PickupsButtons, "Item Lag 2", "", "", (val) =>
                {
                    if (val)
                    {
                        Items.itemlag2 = true;
                ...
                new SingleButton(MainMenuButtons, "Kill Self", "Kill Self with Grenade", () =>
                {
                    try
                    {
                        ...
                        {
                            SetRole(Player.prop_Player_0, "Kill");
                        }
                    }
                    catch { }
                }, false, KillSelfIcon);
                    ...
                    foreach (var events in Udon.GetUdonBehaviourGameObjects())
                    {
                        new SimpleSingleButton(UdonEventsButtons, events.gameObject.name, null, () =>
                        {
                            ...
                            foreach (var uwu in events.GetComponent<UdonBehaviour>()?._eventTable)
                            {
                                ...
                                {
                                    Udon.CallUdonEvent(events.GetComponent<UdonBehaviour>(), uwu.Key);
                                });
                            }
                        });
                    }
            ...
            new ToggleButton(Murder3QuickMenuButtons, "Give Patreon", null, null, (val) =>
                ...
                {
                    if (!AmongUs.worldLoaded) return;
                    SetRole(selectedplayer, "SyncVotedOut");
                });
        ...
        internal static void SetRole(Player player, string role)
        {
            ...
            try
            {
                ...
                foreach (var playerentry in Murder4.PlayerEntrys)
                {
                    ...
                    {
                        playernode = playerentry.gameObject.name.ToString().Replace("Player Entry", "Player Node");
                        playernodeudon = GameObject.Find($"Game Logic/Player Nodes/{playernode}").GetComponent<UdonBehaviour>();
                        if (role == "Murderer")
                        {
        ...
        internal static IEnumerator TouchSysAll()
        {
            ...
            foreach (var Player in players)
            {
                if (Vector3.Distance(Utils.CurrentUser.field_Private_VRCAvatarManager_0.gameObject.transform.position, Player.transform.position) < 0.6f && !Networking.LocalPlayer.GetPickupInHand(VRC_Pickup.PickupHand.Right))
                {
                    ...
                    {
                        if (Utils.touchsystoggle == "Grenade")
                        {
                            PatchManager.inv = true;
                            MelonCoroutines.Start(Murder4.KillSelectedPlayerFrag(Player));
                            yield break;
                        }
                        else if (Utils.touchsystoggle == "Beartrap")
                        {
                            Items.TakeOwnershipIfNecessary(Murder4Items.Beartrap);
                            Udon.CallUdonEvent(Murder4Items.Beartrap.GetComponent<VRC.Udon.UdonBehaviour>(), "SyncArm");
                            Murder4Items.Beartrap.transform.position = Player.transform.position + new Vector3(0, 0.1f, 0);
                            yield break;
                        }
                        else
                        {
                            Utils.SetRole(Player, Utils.touchsystoggle);
                            yield break;
                        }
                    }
                }
        ...
        internal static IEnumerator TouchSystemClues() 
        {
            if (Utils.touchsystoggle == "Clues")
            {
                var players = Utils.GetAllPlayers();
                foreach (var Player in players)
                {
        ...
        private static Transform MakeTag(Transform stats, int index)
        {
            ...
            rank.name = $"JoanpixerClientTag{index}";
        ...
        {
            Transform tag = contents.Find($"JoanpixerClientTag{stack}");
            Transform label;
            if (tag == null)
        ...
        public static IEnumerator Notification(string Text, Color color)
        {
            ...
            indicator.name = "NotifyDot-" + "JoanpixerClient";

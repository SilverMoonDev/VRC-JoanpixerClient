...
namespace JoanpixerClient.Modules
{
	class Items
	{
        ...
        #endregion
        public static bool AutoDropToggle = true;

        internal static bool AntiTheftenabled = FoldersManager.Create.Ini.GetBool("Toggles", "AntiTheft");
        ...
        public static bool AllowThiefenabled;

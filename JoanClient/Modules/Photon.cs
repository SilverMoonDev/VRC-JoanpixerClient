...
namespace JoanpixerClient.Modules
{
    internal static class PhotonModule
    {
		...
		public static IEnumerator DisconnectLobby()
		{
			for (; ; )
            {
				...
				VrcEvent vrcEvent = new VrcEvent
				{
					...
					ParameterInt = 1,
					ParameterFloat = 0f,
					ParameterString = "<3 Get Fucked <3 | " + RandomString(820) + " | <3 Get Fucked <3",
		...
		public static void DebugSpam()
		{
			for (int i = 0; i < 3; i++)
			{
				SendRPC(VrcEventType.SendRPC, "SendRPC", GameObject.Find("Camera (eye)").gameObject, 1, 0, "Ur Mom is Gay L̛̛̾̈́̈̋͛͊̍͛̆̑̐̉̒̈̀̋̉̇̄͐͆͛͆́́̐͆̃̉̿́̀̐͋͐̃̎̅̊̀̌̾̎̓̽͛̑̃̿̈́͐̀̉̍͐̀͋̆̑̌̑̓̆̍̏͆̔̍͗̇́͋̓̍́̾͊̅̍̃̆͌̃͑͐̀̿̈́́̕͘̕͘̕̕͘͝͠͠͞͝͞͝͝͞͞͞͞͝͞L̛̛̾̈́̈̋͛͊̍͛̆̑̐̉̒̈̀̋̉̇̄͐͆͛͆́́̐͆̃̉̿́̀̐͋͐̃̎̅̊̀̌̾̎̓̽͛̑̃̿̈́͐̀̉̍͐̀͋̆̑̌̑̓̆̍̏͆̔̍͗̇́͋̓̍́̾͊̅̍̃̆͌̃͑͐̀̿̈́́̕͘̕͘̕̕͘͝͠͠͞͝͞͝͝͞͞͞͞͝͞", VrcBooleanOp.Unused, VrcBroadcastType.AlwaysUnbuffered);
			}
		}

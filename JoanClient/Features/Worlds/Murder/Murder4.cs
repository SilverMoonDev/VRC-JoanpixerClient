...
namespace JoanpixerClient.Features.Worlds
{
    class Murder4
    {
        ...
        public static UdonBehaviour fragudon;
        public static UdonBehaviour revolver;
        public static VRC_Pickup revolverpickup;
        ...
        public static void Initialize()
        {
            ...
            if (RoomManager.field_Internal_Static_ApiWorldInstance_0?.worldId == "wrld_858dfdfc-1b48-4e1e-8a43-f0edc611e5fe")
            {
                ...
                GameObject.Find("Game Logic/Player HUD/Flashbang HUD Anim").GetComponent<Animator>().enabled = false;
                ...
                Murder4Items.snakedispenser = GameObject.Find("Game Logic/Snakes/SnakeDispenser/")?.GetComponent<UdonBehaviour>();
                ...
                GameObject.Find("Game Logic/Weapons/Revolver/Recoil Anim/Recoil/Laser Sight").active = LaserSight;
            }
            else
            {
                worldLoaded = false;
        ...
        public static void UnLockDoors()
        {
            foreach (var door in Resources.FindObjectsOfTypeAll<UdonBehaviour>())
            {
                ...
                {
                    UdonBehaviour door1 = GameObject.Find(doors + "/Door")?.GetComponent<UdonBehaviour>();
                    Udon.CallUdonEvent(door, "SyncBreakL");
                    Udon.CallUdonEvent(door1, "SyncBreakL");
                }
            }
        }
